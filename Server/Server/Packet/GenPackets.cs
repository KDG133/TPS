...
public class S_BroadcastEnterGame : IPacket
{
    ...
    public void Read(ArraySegment<byte> segment)
    {
		...
		count += sizeof(float);
		this.rotX = BitConverter.ToSingle(s.Slice(count, s.Length - count));
		count += sizeof(float);
		this.rotY = BitConverter.ToSingle(s.Slice(count, s.Length - count));
		count += sizeof(float);
		this.rotZ = BitConverter.ToSingle(s.Slice(count, s.Length - count));
		count += sizeof(float);
    }
    ...
    public ArraySegment<byte> Write()
    {
		...
		count += sizeof(float);
		success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), this.rotX);
		count += sizeof(float);
		success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), this.rotY);
		count += sizeof(float);
		success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), this.rotZ);
		count += sizeof(float);
